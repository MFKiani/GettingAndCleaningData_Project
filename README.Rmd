...
- The dataset generated as part of step 5 of the assignment is named as **"newdata.txt"** (by running *run_analysis.R*). Both the newdata.csv dataset and the *run_analysis.R* is also in the github repository as this README file. 
